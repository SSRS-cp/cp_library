...
data:
  ...
  attributes:
    links: []
  bundledCode: "#line 1 \"old_Graph/Rerooting_2.cpp\"\nint dfs1(vector<int> &dp, vector<vector<int>>\
  ...
  verifiedWith: []
documentation_of: old_Graph/Rerooting_2.cpp
layout: document
redirect_from:
- /library/old_Graph/Rerooting_2.cpp
- /library/old_Graph/Rerooting_2.cpp.html
